...
/*#if MIN_COMPILER_VERSION > 515 SUNSEEKER EDIT - REMOVAL - START
	...
	target.stat_panel.send_message("update_stat", list(
		"global_data" = global_data, // SUNSEEKER EDIT - PREVIOUS: "global_data" = (target.byond_version < 516) ? global_data : (global_data + beta_notice),
